          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                ...
                in praesentium ut quibusdam aliquid officia?
              </p>
              <button
              ...
              <button className="btn btn-outline-danger btn-lg rounded-1 me-2 animate__animated animate__fadeInUp animate__delay-1s">
                Lihat Promo
              </button>
            </Col>
